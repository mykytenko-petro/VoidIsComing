...
public class ModSkills {
    ...
    public static final Identifier RESILIENCE_BONUS = VoidIsComing.id("resilience_bonus_skill");
    ...
    public static final Identifier SPEED_BONUS = VoidIsComing.id("speed_bonus_skill");
    ...
    public static final Identifier AFFINITY_BONUS = VoidIsComing.id("affinity_bonus_skill");
    ...
    public static void registerSkills() {
        ...
        registerSkill(new SkillNode(CONCENTRATION_SPELL, 5, ModSpells.CONCENTRATION));
        ...
        registerSkill(new SkillNode(PURIFICATION_SPELL, STONE_BASTION, 3, ModSpells.PURIFICATION));
        ...
        registerSkill(new SkillNode(LAST_STAND_SPELL, WILD_BLOOM, 3, ModSpells.LAST_STAND));
        ...
        registerSkill(new SkillNode(MANA_BOOST_SPELL, ABYSSAL_RESERVOIR, 3, ModSpells.MANA_BOOST));
    }
