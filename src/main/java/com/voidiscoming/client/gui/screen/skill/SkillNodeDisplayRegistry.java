...
public class SkillNodeDisplayRegistry {
    ...
    public static void registerNodes() {
        ...
        register(new SkillNodeDisplay(ModSkills.STONE_BASTION, -10, -180, "stone_bastion", VoidIsComing.id("textures/gui/skills/armor.png")));
        register(new SkillNodeDisplay(ModSkills.RESILIENCE, -40, -100, "resilience", VoidIsComing.id("textures/gui/skills/warrior_class.png")));
        ...
        register(new SkillNodeDisplay(ModSkills.WILD_BLOOM, 100, 165, "wild_bloom", VoidIsComing.id("textures/gui/skills/heart.png")));
        register(new SkillNodeDisplay(ModSkills.SWIFTSTEP, 100, 70, "swiftstep", VoidIsComing.id("textures/gui/skills/archer_class.png")));
        ...
        register(new SkillNodeDisplay(ModSkills.ABYSSAL_RESERVOIR, -130, 135, "abyssal_reservoir", VoidIsComing.id("textures/gui/skills/mana.png")));
        register(new SkillNodeDisplay(ModSkills.AFFINITY, -50, 100, "affinity", VoidIsComing.id("textures/gui/skills/mana.png")));
