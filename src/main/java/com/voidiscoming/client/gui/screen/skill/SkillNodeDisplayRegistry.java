...
public class SkillNodeDisplayRegistry {
    ...
    public static void registerNodes() {
        ...
        register(new SkillNodeDisplay(ModSkills.CONCENTRATION_SPELL, -500, 500, "concentration_spell", VoidIsComing.id("textures/gui/skills/concentration.png")));
        ...
        register(new SkillNodeDisplay(ModSkills.RESILIENCE_BONUS, -40, -100, "resilience_bonus", VoidIsComing.id("textures/gui/skills/resilience.png")));
        ...
        register(new SkillNodeDisplay(ModSkills.PURIFICATION_SPELL, -120, -130, "purification_spell", VoidIsComing.id("textures/gui/skills/purification.png")));
        ...
        register(new SkillNodeDisplay(ModSkills.SPEED_BONUS, 100, 70, "speed_bonus", VoidIsComing.id("textures/gui/skills/speed.png")));
        ...
        register(new SkillNodeDisplay(ModSkills.LAST_STAND_SPELL, 130, 130, "last_stand_spell", VoidIsComing.id("textures/gui/skills/last_stand.png")));
        ...
        register(new SkillNodeDisplay(ModSkills.AFFINITY_BONUS, -50, 100, "affinity_bonus", VoidIsComing.id("textures/gui/skills/affinity.png")));
